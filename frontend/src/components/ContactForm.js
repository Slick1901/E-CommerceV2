    ...
    <div>
      <section className="text-gray-600 body-font relative p-4" id="contact">
        ...
        <div className="container px-5 pb-2 mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-2/3 md:w-1/2 bg-[url(https://media.istockphoto.com/id/120251260/photo/south-see-pearls-in-a-shell.jpg?s=612x612&w=0&k=20&c=retWrKL_xcxL_ghXiCNhpckbhhN5f27pSTCBZYKqDYw=)] bg-cover bg-center bg-no-repeat rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
